        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="index.php">Home</a></li>
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="restaurants,php">Store</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span><a href="checkout.php"> Add to Cart </a></li>
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/img2.png">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>Available for Self-Pickup Only!</p>
                                        <?php
                                        if($item_total==0){
                                        ?>
