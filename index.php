...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/two.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1> Sheila's Buko Pie </h1>
                    ...
                    <div class="steps">
                        ...
                        <g fill="#FFF">
                          <path d="M15.985 8.5H8.207l-5.5 5.5a8 8 0 0 0 13.277-5.5zM2 13.292A8 8 0 0 1 7.5.015v7.778l-5.5 5.5zM8.5.015V7.5h7.485A8.001 8.001 0 0 0 8.5.015z"/>
                            ...
                            <h4><span style="color:white;">1.</span> Choose a Products</h4> </div>
                
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewbox="0 0 380.721 380.721">
                                        <g fill="#FFF">
                            ...
                            <h4><span style="color:white;">2.</span> Reservation</h4> </div>
              
                        <div class="step-item step3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"  class="bi bi-shop" viewBox="0 0 12 18">
                           <g fill="#FFF">
                        <path d="M2.97 1.35A1 1 0 0 1 3.73 1h8.54a1 1 0 0 1 .76.35l2.609 3.044A1.5 1.5 0 0 1 16 5.37v.255a2.375 2.375 0 0 1-4.25 1.458A2.371 2.371 0 0 1 9.875 8 2.37 2.37 0 0 1 8 7.083 2.37 2.37 0 0 1 6.125 8a2.37 2.37 0 0 1-1.875-.917A2.375 2.375 0 0 1 0 5.625V5.37a1.5 1.5 0 0 1 .361-.976l2.61-3.045zm1.78 4.275a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 1 0 2.75 0V5.37a.5.5 0 0 0-.12-.325L12.27 2H3.73L1.12 5.045A.5.5 0 0 0 1 5.37v.255a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0zM1.5 8.5A.5.5 0 0 1 2 9v6h1v-5a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5h6V9a.5.5 0 0 1 1 0v6h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1V9a.5.5 0 0 1 .5-.5zM4 15h3v-5H4v5zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-3zm3 0h-2v3h2v-3z"/>
                            ...
                            <h4><span style="color:white;"> 3. </span> Self-Pickup </h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>BEST SELLER</h2>
                    <p class="lead"> These are the three best-selling pies to choose form. Pick your Favorite!  </p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">₱'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Reserve Now</a> </div>
                                                </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                            ...
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    <div class="icon" data-step="1">
                                        <<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pie-chart-fill" viewBox="0 0 18 16">
                                            <g fill="#FFF">
                                            <path d="M15.985 8.5H8.207l-5.5 5.5a8 8 0 0 0 13.277-5.5zM2 13.292A8 8 0 0 1 7.5.015v7.778l-5.5 5.5zM8.5.015V7.5h7.485A8.001 8.001 0 0 0 8.5.015z"/>
                                                    </svg>
                                            </g>
                                    ...
                                    <p>We've got you covered with variety of PIES that is fit for your likeness!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Make a Reservation depending on your schedule.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3> Self-Pick up </h3>
                                <p>You may pick up your order at our shop when the procedure is completed.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">GCASH AND CASH PAYMENT</p>
                    </div>
                </div>
            </div>
        </section>
